    ...
    <main style={{ paddingTop: "120px", paddingBottom: "80px" }}>
      ...
      >
        ...
        <div style={{ position: "relative", zIndex: 1 }}>
          ...
          >
            Every bride deserves a gown that tells her story. Our bridal collection is
            crafted with the finest fabrics and meticulous attention to detail, creating
            masterpieces that will be remembered for a lifetime.
          </p>
      ...
      <section style={{ padding: "5rem 2rem", maxWidth: "1400px", margin: "0 auto" }}>
        ...
        {products.length === 0 ? (
          ...
          >
            ...
            >
              Our bridal couture is being crafted with the utmost care.
            </p>
          </div>
        ) : (
          <div
